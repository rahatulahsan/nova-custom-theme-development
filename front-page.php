    ...
    <section id="why-us" class="why-us">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row g-0" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-xl-5 img-bg" style="background-image: url('<?php echo get_theme_file_uri( 'assets/img/why-us-bg.jpg' ); ?>')"></div>
        ...
        <div class="row">
          ...
          <div class="col-lg-5 position-relative" data-aos="fade-up" data-aos-delay="200">
            <div class="phone-wrap">
              <img src="<?php echo get_theme_file_uri( '/assets/img/iphone.png' ); ?>" alt="Image" class="img-fluid">
            </div>
          </div>
        </div>
